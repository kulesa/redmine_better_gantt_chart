...
2. Run 'git clone git://github.com/kulesa/redmine_gantt.git'. Or if you don't have git, click '*Download*' button on this page, save and unpack archive in plugins directory, and rename extracted folder to '*redmine_better_gantt_chart*'
3. Restart Redmine
