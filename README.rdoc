...
Tested with Redmine versions: 1.1.0, 1.1.1, 1.1.2, 1.1.3, 1.2, 1.3, 1.4, 2.2, 2.3, 2.4, 3.3

== Installation and Setup

1. Go to releases page: https://github.com/kulesa/redmine_better_gantt_chart/releases
2. For Redmine 3.x above run 'git clone git://github.com/kulesa/redmine_better_gantt_chart.git'. Or if you don't have git, click '*Download*' button on this page, and save. For Redmine 2.x download {version 0.9.0}[https://github.com/kulesa/redmine_better_gantt_chart/releases/download/v.0.9.0/redmine_better_gantt_chart_0.9.0.zip] or above. For Redmine 1.x download {version 0.6.1}[https://github.com/kulesa/redmine_better_gantt_chart/archive/v0.6.1.zip].
